...
<head>
  ...
  <title>Elecciones - {{ $page_title ?? ''}}</title>
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed {{Session::get('sidebar-collapse') ?? ''}}">
<div class="wrapper">
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <!-- SEARCH FORM -->
    <form id="form-search" class="form-inline ml-3">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <div class="dropdown-divider"></div>
          <a href="{{URL::to('lockscreen')}}" class="dropdown-item">
            <i class="fas fa-users mr-2"></i> Lockscreen
          </a>
        </div>
      </li>
