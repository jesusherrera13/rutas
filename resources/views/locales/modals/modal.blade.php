				...
				<div class="row">
					...
					<div class="col-12">
						<form id="form-registro" class="form-horizontal" action="" method="post" enctype="multipart/form-data">
							...
							<div class="form-group row">
							    <label for="distrito_federal" class="col-sm-4 col-form-label">Distrito Federal:</label>
							    <div class="col-sm-8">
							        <select id="distrito_federal" class="custom-select custom-select-sm" multiple>
